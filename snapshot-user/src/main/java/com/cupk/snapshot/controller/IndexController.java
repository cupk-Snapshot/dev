    ...
    public R getAll() {
        ...
        accepts.forEach(i -> {
            ...
            if (report.getPic2Url() != null) {
                url2.put("url2", report.getPic1Url());
                list.add(url2);
            }

            HashMap<String, String> url3 = new HashMap<>();
            if (report.getPic3Url() != null) {
                url3.put("url3", report.getPic1Url());
                list.add(url3);
            }


            Map<String, Object> map = new HashMap<>();
            Map<String, Object> stringObjectMap = BeanUtil.beanToMap(userVo, new HashMap<>(), false, false);
